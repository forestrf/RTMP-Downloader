			...
			return getCabeceraHTML() +
					"<div id=\"contenido\">" +
						...
						"<form id=\"form_agregar\" class=\"tabla\" method=\"GET\">" +
							...
							"<div class=\"elemento\">" +
								"<div>Comando: </div><div><input type=\"text\" name=\"url\" size=\"60\" placeholder=\"comando rtmpdump\"></div>" +
							"</div>" +
							"<div class=\"elemento\">" +
